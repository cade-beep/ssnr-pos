...
const ReceiptModal: React.FC<ReceiptModalProps> = ({ receipt, onClose }) => {
  ...
  return (
    <div className="modal-overlay" style={{ zIndex: 1100 }}>
      <div className="modal-content" style={{ maxWidth: '420px', minHeight: '740px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <div className="modal-body" style={{ padding: '24px 24px 4px 24px', flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '16px', flexShrink: 0 }}>
            ...
            <h2 style={{ fontSize: '18px', fontWeight: '700' }}>결제 완료</h2>
            <p style={{ color: 'var(--text-secondary)', fontSize: '12px', marginTop: '2px' }}>성공적으로 결제가 완료되었습니다.</p>
          </div>

          {/* Styled Receipt Paper */}
          <div className="receipt-paper" style={{ flex: 1, display: 'flex', flexDirection: 'column', maxHeight: '500px', overflowY: 'auto', marginBottom: '12px' }}>
            ...
            <div className="receipt-item-row" style={{ fontWeight: '700', borderBottom: '1px solid #cbd5e1', paddingBottom: '4px' }}>
              <div className="receipt-item-name">상품명</div>
              <div className="receipt-item-qty">수량</div>
              <div className="receipt-item-amount">금액</div>
            </div>
            ...
            <div className="receipt-row big" style={{ borderTop: 'none', paddingTop: 0, marginTop: 0 }}>
              <span>청구합계</span>
        ...
        <div className="modal-footer">
          <button type="button" className="btn btn-secondary" style={{ flex: 1 }} onClick={handlePrint}>
            <Printer size={14} />
            <span>영수증 출력</span>
          </button>
          <button type="button" className="btn btn-primary" style={{ flex: 1.5 }} onClick={onClose}>
            닫기
          </button>
        </div>
      </div>
